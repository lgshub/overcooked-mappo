...
def get_config():
    ...
    # eval parameters
    parser.add_argument("--use_eval", action='store_true', default=0, help="by default, do not start evaluation. If set`, start evaluation alongside with training.")
    ...
    parser.add_argument("--use_render", action='store_true', default=0, help="by default, do not render the env during training. If set, start render. Note: something, the environment has internal render process which is not controlled by this hyperparam.")
