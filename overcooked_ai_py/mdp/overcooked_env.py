...
class OvercookedEnv(object):
    ...
    def step(self, joint_action):
        ...
        return (next_state, reward_shaping, done, info)
...
class Overcooked(gym.Env):
    ...
    def __init__(self, base_env, featurize_fn=None, baselines=False):
        """
    ...
    def _setup_observation_space(self):
        ...
        obs_shape = self.base_env.mdp.featurize_fn(dummy_state)[0].shape
        # obs_shape = [1,2]
    ...
    def step(self, action):
        ...
        agent_action, other_agent_action = [Action.INDEX_TO_ACTION[np.argmax(a)] for a in action[0]]
        ...
        ob_p0, ob_p1 = self.base_env.mdp.featurize_fn(next_state)
        if self.agent_idx == 0:
    ...
    def reset(self):
        ...
        ob_p0, ob_p1 = self.base_env.mdp.featurize_fn(self.base_env.state)
        if self.agent_idx == 0:
            both_agents_ob = (ob_p0, ob_p1)
        else:
            both_agents_ob = (ob_p1, ob_p0)
